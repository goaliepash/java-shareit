...
class ItemServiceTest {
    ...
    public void testUpdateWithWrongItemOwner() {
        ...
        Assertions.assertEquals("Указан неверный владелец вещи.", exception.getMessage());
    }
    ...
    void testAddCommentWithoutBooking() {
        ...
        Assertions.assertEquals("Нельзя добавить комментарий к вещи 1 без бронирования.", exception.getMessage());
    }
    ...
    void testAddCommentWithCurrentBooking() {
        ...
        Assertions.assertEquals("Нельзя добавить комментарий к вещи 1 с запланированными бронированиями.", exception.getMessage());
    }
}